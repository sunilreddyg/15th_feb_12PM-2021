...
public class Read_Spefic_Row_Data_From_DynamicRows {

	public static void main(String[] args) 
	{
		/*
		 * Read data from dynamic rows using any reference text..
		 */
		...
		for (int i = 0; i < rows.size(); i++) 
		{
			...
			if(RowText.contains("Wipro"))
			{
				...
				break;  //Stop Iteration once data was read
			}
